    ...
    internal class EventHandlers
    {
        ...
        internal void RegisterEvents()
        {
            try
            {
                ...
                if (_config.Debug)
                    Log.Debug("События EventHandlers зарегистрированы успешно");
            }
            catch (Exception ex)
            {
                Log.Error("Ошибка регистрации событий EventHandlers: " + ex.ToString());
            }
        }
        ...
        internal void UnregisterEvents()
        {
            try
            {
                ...
                if (_config.Debug)
                    Log.Debug("События EventHandlers отменены успешно");
            }
            catch (Exception ex)
            {
                Log.Error("Ошибка отмены регистрации событий EventHandlers: " + ex.ToString());
            }
        }
        ...
        private void OnRoundStarted()
        {
            ...
            {
                Log.Error("Ошибка в OnRoundStarted: " + ex.ToString());
            }
        }
        ...
        private void OnRoundEnded(RoundEndedEventArgs ev)
        {
            ...
            {
                Log.Error("Ошибка в OnRoundEnded: " + ex.ToString());
            }
        }
        ...
        private void OnPickingUpItem(PickingUpItemEventArgs ev)
        {
            try
            {
                ...
                Timing.CallDelayed(0.1f, () =>
                {
                    ...
                    {
                        if (_config.Debug)
                            Log.Error("Ошибка при добавлении маски в инвентарь: " + ex2.ToString());
                    }
                });
            ...
            {
                Log.Error("Ошибка в OnPickingUpItem: " + ex.ToString());
            }
        }
        ...
        private void OnUsingItem(UsingItemEventArgs ev)
        {
            ...
            {
                Log.Error("Ошибка в OnUsingItem: " + ex.ToString());
            }
        }
        ...
        private void OnDroppingItem(DroppingItemEventArgs ev)
        {
            try
            {
                ...
                if (playersWithMasks.TryGetValue(ev.Player, out var maskItem) && maskItem == ev.Item)
                {
                    ...
                    Timing.CallDelayed(0.1f, () =>
                    {
                        ...
                        {
                            if (_config.Debug)
                                Log.Error("Ошибка при возвращении маски на карту: " + ex2.ToString());
                        }
                    });
                }
            }
            ...
            {
                Log.Error("Ошибка в OnDroppingItem: " + ex.ToString());
            }
        }
        ...
        private void OnChangingRole(ChangingRoleEventArgs ev)
        {
            ...
            {
                Log.Error("Ошибка в OnChangingRole: " + ex.ToString());
            }
        }
        ...
        private void OnPlayerLeave(DestroyingEventArgs ev)
        {
            ...
            {
                Log.Error("Ошибка в OnPlayerLeave: " + ex.ToString());
            }
        }
        ...
        private void OnPlayerLeft(LeftEventArgs ev)
        {
            ...
            {
                Log.Error("Ошибка в OnPlayerLeft: " + ex.ToString());
            }
        }
        ...
        private void CleanupPlayer(Player player)
        {
            ...
            {
                if (_config.Debug)
                    Log.Error("Ошибка в CleanupPlayer: " + ex.ToString());
            }
        }
            ...
            if (_config.ActivationType == ActivationType.ServerSpecificSettings)
            {
                try
                {
                    ...
                    Timing.CallDelayed(2f, () =>
                    {
                        ...
                        {
                            if (_config.Debug)
                                Log.Debug("Ошибка отправки настроек игроку " + ev.Player.Nickname + ": " + ex2.ToString());
                        }
                    });
                }
                catch (Exception ex)
                {
                    if (_config.Debug)
                        Log.Debug("Ошибка при попытке отправить настройки игроку " + ev.Player.Nickname + ": " + ex.ToString());
                }
            }
        }
        ...
        private void OnSettingValueReceived(ReferenceHub hub, ServerSpecificSettingBase settingBase)
        {
            ...
            {
                Log.Error("Ошибка в OnSettingValueReceived: " + ex.ToString());
            }
        }
        ...
        private void OnTogglingNoClip(TogglingNoClipEventArgs ev)
        {
            ...
            {
                Log.Error("Ошибка в OnTogglingNoClip: " + ex.ToString());
            }
        }
        ...
        public void TryInteractWithScp096(Player player)
        {
            ...
            {
                Log.Error("Ошибка в TryInteractWithScp096: " + ex.ToString());
            }
        }
        ...
        private IEnumerator<float> EquipMaskProcess(Player player, Player scp096)
        {
            ...
            try
            {
                ...
                while (elapsed < equipTime)
                {
                    ...
                    string progressText = "<color=yellow>[" + progressBar + "] " + (progress * 100).ToString("F0") + "%</color>";
            ...
            {
                Log.Error("Ошибка в EquipMaskProcess: " + ex.ToString());
                if (equipProcesses.ContainsKey(player))
                    equipProcesses.Remove(player);
            }
        }
        ...
        private void CompleteMaskEquipping(Player player, Player scp096)
        {
            ...
            {
                Log.Error("Ошибка в CompleteMaskEquipping: " + ex.ToString());
            }
        }
        ...
        public void SpawnMasks()
        {
            try
            {
                ...
                {
                    if (_config.Debug)
                        Log.Debug("Маски не заспавнены - недостаточно игроков (" + Player.List.Count().ToString() + "/" + _config.AdvancedSpawn.MinPlayersForSpawn.ToString() + ")");
                    return;
                }
            ...
            {
                Log.Error("Ошибка в SpawnMasks: " + ex.ToString());
            }
        }
        ...
        private void SpawnMasksAdvanced()
        {
            try
            {
                    ...
                    foreach (var room in rooms)
                    {
                        ...
                        for (int i = 0; i < masksToSpawnInRoom; i++)
                        {
                            ...
                            if (pickup != null)
                            {
                                ...
                                {
                                    Log.Info("Маска SCP-096 создана в " + room.Type.ToString() + " (" + spawnPosition.ToString() + ")");
                                }
                            }
                        }
                    }
                ...
                if (_config.Debug)
                    Log.Debug("Продвинутый спавн: создано " + totalSpawned.ToString() + " масок");
            }
            catch (Exception ex)
            {
                Log.Error("Ошибка в SpawnMasksAdvanced: " + ex.ToString());
            }
        }
            ...
            try
            {
                ...
                for (int i = 0; i < masksToSpawn && spawnedCount < masksToSpawn; i++)
                {
                    Timing.CallDelayed(0.5f * i, () =>
                    {
                                ...
                                TryFindSpawnPosition(out Vector3 position))
                            {
                                ...
                                if (pickup != null)
                                {
                                    ...
                                    if (_config.AdvancedSpawn.LogMaskSpawns)
                                    {
                                        ...
                                        if (parentRoom != null)
                                            Log.Info("Маска SCP-096 создана в " + parentRoom.Type.ToString() + " (" + position.ToString() + ")");
                                        else
                                            Log.Info("Маска SCP-096 создана в неизвестной комнате (" + position.ToString() + ")");
                                    }
                                }
                            }
                        }
                        ...
                        {
                            if (_config.Debug)
                                Log.Error("Ошибка в SpawnMasksLegacy callback: " + ex2.ToString());
                        }
                    });
                }

                if (_config.Debug)
                    Log.Debug("Обычный спавн: запущен спавн " + masksToSpawn.ToString() + " масок SCP-096");
            }
            catch (Exception ex)
            {
                Log.Error("Ошибка в SpawnMasksLegacy: " + ex.ToString());
            }
        }
        ...
        private Pickup CreateMaskPickup(Vector3 position)
        {
            ...
            {
                if (_config.Debug)
                    Log.Error("Ошибка создания пикапа маски: " + ex.ToString());
                return null;
            }
        }
        ...
        private bool TryFindSpawnPosition(out Vector3 position)
        {
            ...
            {
                if (_config.Debug)
                    Log.Error("Ошибка в TryFindSpawnPosition: " + ex.ToString());
                return false;
            }
        }
        ...
        private bool TrySpawnInSpecificRoom(out Vector3 position)
        {
            ...
            {
                if (_config.Debug)
                    Log.Error("Ошибка в TrySpawnInSpecificRoom: " + ex.ToString());
                return false;
            }
        }
        ...
        private bool TrySpawnInZone(out Vector3 position)
        {
            ...
            {
                if (_config.Debug)
                    Log.Error("Ошибка в TrySpawnInZone: " + ex.ToString());
                return false;
            }
        }
        ...
        private bool TryFindValidPositionInRoom(Room room, out Vector3 position)
        {
            ...
            {
                if (_config.Debug)
                    Log.Error("Ошибка в TryFindValidPositionInRoom: " + ex.ToString());
                return false;
            }
        }
        ...
        private bool IsValidSpawnPosition(Vector3 position)
        {
            ...
            {
                if (_config.Debug)
                    Log.Error("Ошибка в IsValidSpawnPosition: " + ex.ToString());
                return false;
            }
        }
        ...
        private void ApplyMaskVisualEffects(Pickup pickup)
        {
            ...
            {
                if (_config.Debug)
                    Log.Error("Ошибка в ApplyMaskVisualEffects: " + ex.ToString());
            }
        }
        ...
        private IEnumerator<float> MaskVisualEffectsRoutine(Pickup pickup)
        {
            ...
            try
            {
                while (pickup != null && pickup.IsSpawned && spawnedMasks.Contains(pickup))
                {
                    ...
                    {
                        if (_config.Debug)
                            Log.Debug("Ошибка в визуальных эффектах маски: " + ex.ToString());
                        break;
                    }
            ...
            {
                Log.Error("Ошибка в MaskVisualEffectsRoutine: " + ex.ToString());
            }
            finally
            {
        ...
        private IEnumerator<float> RespawnMasksRoutine()
        {
                        ...
                        random.NextDouble() * 100 < _config.AdvancedSpawn.RespawnChance)
                    {
                        if (TryFindSpawnPosition(out Vector3 position))
                        {
                            ...
                            if (pickup != null)
                            {
                                ...
                                {
                                    if (room != null)
                                        Log.Info("Респавн маски SCP-096 в " + room.Type.ToString());
                                    else
            ...
            {
                Log.Error("Ошибка в RespawnMasksRoutine: " + ex.ToString());
            }
        }
        ...
        public void ClearAllMasks()
        {
            try
            {
                foreach (var mask in spawnedMasks.ToList())
                {
                    ...
                    {
                        if (_config.Debug)
                            Log.Debug("Ошибка при удалении маски: " + ex.ToString());
                    }
                }
                spawnedMasks.Clear();
            ...
            {
                Log.Error("Ошибка в ClearAllMasks: " + ex.ToString());
            }
        }
        ...
        private void ClearAllData()
        {
            ...
            {
                Log.Error("Ошибка в ClearAllData: " + ex.ToString());
            }
        }
        ...
        private void ShowHint(Player player, string message, float duration)
        {
            ...
            {
                if (_config.Debug)
                    Log.Error("Не удалось показать хинт: " + ex.ToString());
            }
        }
        ...
        public bool HasMask(Player player)
        {
            ...
            {
                if (_config.Debug)
                    Log.Error("Ошибка в HasMask: " + ex.ToString());
                return false;
            }
        }
        ...
        public void AddPlayerMask(Player player, Item maskItem)
        {
            ...
            {
                if (_config.Debug)
                    Log.Error("Ошибка в AddPlayerMask: " + ex.ToString());
            }
        }
        ...
        public bool IsScp096Masked(Player scp096)
        {
            ...
            {
                if (_config.Debug)
                    Log.Error("Ошибка в IsScp096Masked: " + ex.ToString());
                return false;
            }
        }
        ...
        public void RemoveMaskFromScp096(Player scp096)
        {
            ...
            {
                Log.Error("Ошибка в RemoveMaskFromScp096: " + ex.ToString());
            }
        }
        ...
        public int GetMaskCount()
        {
            ...
            {
                if (_config.Debug)
                    Log.Error("Ошибка в GetMaskCount: " + ex.ToString());
                return 0;
            }
        }
        ...
        public int GetMaskedScp096Count()
        {
            ...
            {
                if (_config.Debug)
                    Log.Error("Ошибка в GetMaskedScp096Count: " + ex.ToString());
                return 0;
            }
        }
        ...
        public List<Player> GetMaskedScp096s()
        {
            ...
            {
                if (_config.Debug)
                    Log.Error("Ошибка в GetMaskedScp096s: " + ex.ToString());
